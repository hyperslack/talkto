  ...
  return (
    <AvatarPrimitive.Root
      ...
      className={cn(
        ...
        shape === "square" ? "rounded-lg data-[size=sm]:rounded-md" : "rounded-full",
        className
      )}
      {...props}
    />
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        ...
        "group-data-[shape=circle]/avatar:rounded-full group-data-[shape=square]/avatar:rounded-lg group-data-[shape=square]/avatar:group-data-[size=sm]/avatar:rounded-md",
        className
      )}
      {...props}
    />
