...
make dev       # Starts Bun backend (:8080) + Vite frontend (:3000)
```

The backend serves REST, WebSocket, and MCP from a single process. The frontend proxies API calls to `:8080`.
