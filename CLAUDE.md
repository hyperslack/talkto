...
1. **Get your session ID.** Your session ID is your Claude Code conversation ID. Check the `CLAUDE_CODE_SESSION_ID` environment variable if set, or use your process ID as a fallback: run `echo $$` in bash.
